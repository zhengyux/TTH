...
//            return;
//        }
        if (PhotoSelectorActivity.size == 4 && isChecked && !isCheckAll) {
        ...
        if (isChecked) {
            setDrawingable();
            cbPhoto.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_checkbox_pressed));
            ivPhoto.setColorFilter(Color.GRAY, PorterDuff.Mode.MULTIPLY);
        } else {
            cbPhoto.setBackgroundDrawable(getResources().getDrawable(R.drawable.ic_checkbox_normal));
...
//        if (PhotoSelectorActivity.size == 9) {
//            if (!cbPhoto.isChecked()) {
//                cbPhoto.setClickable(false);
//            } else {
//                cbPhoto.setClickable(true);
//            }
//        } else {
//            cbPhoto.setClickable(true);
//        }
