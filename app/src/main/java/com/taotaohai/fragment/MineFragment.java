...
// 分享时Notification的图标和文字  2.5.9以后的版本不调用此方法
        ...
        oks.setTitleUrl("http://www.taotaohai.com/sharePage/index.html");
        // text是分享文本，所有平台都需要这个字段
        oks.setText("邀请您加入淘淘海");
        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
//        oks.setImagePath("/sdcard/test.jpg");//确保SDcard下面存在此张图片
        oks.setImageUrl("http://www.taotaohai.com/sharePage/start.png");
        // url仅在微信（包括好友和朋友圈）中使用
        oks.setUrl("http://www.taotaohai.com/sharePage/index.html");
        // comment是我对这条分享的评论，仅在人人网和QQ空间使用
        oks.setComment("");
        // site是分享此内容的网站名称，仅在QQ空间使用
        oks.setSite("淘淘海");
        // siteUrl是分享此内容的网站地址，仅在QQ空间使用
        oks.setSiteUrl("http://www.taotaohai.com/sharePage/index.html");
